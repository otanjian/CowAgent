...
(function () {
    ...
    registry["tasks-records"] = {
        "zh": {
            ...
            "tasks_unavailable_desc": "当前身份模式未开放定时任务，请在 legacy 模式下使用，或由管理员适配后开启。",
            "task_add_btn": "新增任务",
        ...
        "zh-Hant": {
            ...
            "tasks_unavailable_desc": "當前身分模式未開放定時任務，請在 legacy 模式下使用，或由管理員適配後開啟。",
            "task_add_btn": "新增任務",
        ...
        "en": {
            ...
            "tasks_unavailable_desc": "Scheduled tasks are not enabled in the current identity mode. Use legacy mode or ask an administrator to adapt them.",
