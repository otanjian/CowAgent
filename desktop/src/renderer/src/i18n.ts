const translations: Record<string, Record<string, string>> = {
  zh: {
    ...
    config_password_account_hint: '账号安全',
    config_password_account_desc: '共享访问密码已退役。请在登录后通过「本人改密」修改数据库账号密码。',
    ...
    login_browser_again: '重新打开浏览器',
    login_browser_failed: '授权未完成，请重试',
    login_bridge_missing: '当前客户端版本不支持浏览器授权，请升级客户端。',
    password_change_title: '需要修改密码',
    password_change_desc: '当前密码为临时密码，修改成功后才能继续使用。',
    password_change_old: '当前密码',
    password_change_new: '新密码',
    password_change_submit: '修改密码',
    password_change_failed: '密码修改失败',
    password_change_relogin: '密码已修改，请重新登录。',
    tenant_select_title: '选择组织',
    tenant_select_desc: '该账号属于多个组织，请选择本次要使用的组织。',
    tenant_select_submit: '进入',
    tenant_invalid: '当前组织已失效，请重新选择。',
    identity_blocked_title: '退出未完成',
    identity_blocked_desc: '服务端未确认注销会话，已停止业务请求。请重试退出。',
    identity_blocked_retry: '重试退出',
    identity_unavailable: '服务暂时不可用，请稍后重试。',
    account_only_title: '暂无可用的组织',
    account_only_desc: '此账号没有有效的组织成员资格，可继续使用账号设置与平台入口；聊天、记忆、渠道等组织业务暂不可用。',
  ...
  en: {
    ...
    config_password_account_hint: 'Account security',
    config_password_account_desc: 'Shared access passwords are retired. Change your database account password via self-service after sign-in.',
    ...
    // login (database account)
    login_title: 'Sign in',
    login_desc: 'Sign in with your database account to continue.',
    ...
    login_browser_again: 'Open the browser again',
    login_browser_failed: 'Authorization was not completed. Please try again.',
    login_bridge_missing: 'This client build does not support browser authorization. Please upgrade.',
    password_change_title: 'Password change required',
    password_change_desc: 'This account still uses a temporary password. Change it to continue.',
    password_change_old: 'Current password',
    ...
    password_change_relogin: 'Password changed. Please sign in again.',
    tenant_select_title: 'Choose an organization',
    tenant_select_desc: 'This account belongs to more than one organization. Choose the one to use now.',
    tenant_select_submit: 'Continue',
    tenant_invalid: 'That organization is no longer available. Please choose again.',
    identity_blocked_title: 'Sign-out did not complete',
    identity_blocked_desc: 'The server did not confirm the sign-out, so requests are stopped. Please retry.',
    identity_blocked_retry: 'Retry sign-out',
    identity_unavailable: 'The service is temporarily unavailable. Please try again.',
    account_only_title: 'No organization available',
    account_only_desc: 'This account has no active organization membership. Account settings and platform entry points remain available; chat, memory, channels and other organization features do not.',
    // slash command descriptions
