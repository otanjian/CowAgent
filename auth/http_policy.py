...
ROUTE_POLICY: Dict[str, Dict[str, dict]] = {
    ...
    "/api/projects": {"GET": {"policy": "closed", "comment": "projects (deferred)"}},
    "/api/projects/select": {"POST": {"policy": "closed", "comment": "project select (deferred)"}},
    "/api/projects/create": {"POST": {"policy": "closed", "comment": "project create (deferred)"}},
    ...
    "/api/tools": {"GET": {"policy": "closed", "comment": "tools (deferred)"}},
    "/api/skills": {"GET": {"policy": "closed", "comment": "skills (deferred)"}},
    "/api/skills/content": {"GET": {"policy": "closed", "comment": "skill content (deferred)"}},
