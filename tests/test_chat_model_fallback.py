...
class TestConsoleValidation:
    ...
    def test_provider_models_is_a_list_per_provider(self, monkeypatch):
        ...
        # The console's model picker reads ConfigHandler.PROVIDER_MODELS (the
        # fork's own catalogue, served through the entry module). Asserting on
        # upstream's channel/web/core/providers.py instead would have kept this
        # green while the fork's catalogue drifted.
