...
# The fork still serves its monolith console, so the page's script set and the
# router's vocabulary are the monolith's, not the split's these tests pin.
# Tracked by the OpenSpec change "adopt-upstream-web-split" (Phase 3, tasks
# 4.4-4.9); this marker comes off with the task that serves the split page.
