...
Deep Dream is the core consolidation mechanism of 容大AI's memory system, responsible for distilling scattered daily memories into refined long-term memory and generating dream diaries.

## Memory Flow

容大AI's memory progresses through three stages from short-term to long-term:
