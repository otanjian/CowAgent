...
description: 容大AI built-in tools system
---
...
<CardGroup cols={2}>
  ...
  <Card title="search_files - File Search" icon="magnifying-glass" href="/tools/search-files">
  ...
  <Card title="agent_delegate - Delegation" icon="users" href="/tools/delegate">
    Hand a task to another Agent in the session
  </Card>
  <Card title="subagent - Sub-Agent" icon="users-gear" href="/tools/subagent">
    Create temporary sub-Agents to run independent tasks in parallel
  </Card>
</CardGroup>
