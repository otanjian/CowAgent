---
title: v2.0.3
description: RongAI 2.0.3 - 企業微信スマートボットとQQチャネルの追加、Webコンソールファイル処理、メモリシステムのアップグレード
---
...
接続ドキュメント：[企業微信スマートボット接続](https://www.rsm.global/china/zh-hans)。
...
接続ドキュメント：[QQボット接続](https://www.rsm.global/china/zh-hans)。
...
詳細設定は [Coding Plan ドキュメント](https://www.rsm.global/china/zh-hans) を参照してください。
...
ソースコードデプロイの場合は `./run.sh update` でワンクリックアップグレードできます。または手動でコードをプルして再起動してください。詳細は [アップデートドキュメント](https://www.rsm.global/china/zh-hans) を参照。
