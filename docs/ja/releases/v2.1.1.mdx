---
title: v2.1.1
description: RongAI 2.1.1 - 自己進化、Web コンソールのメッセージ管理とマルチセッション並行、クロスプラットフォーム対応の MCP 強化、新モデルと改善
---
...
RongAI に **自己進化（Self-Evolution）** が加わりました。Agent は単発のタスクをこなすだけでなく、日々の協働を通じて成長し続けます：
...
ドキュメント：[自己進化](https://www.rsm.global/china/zh-hans)
...
ドキュメント：[MCP ツール](https://www.rsm.global/china/zh-hans)
...
ソースコードでデプロイしている場合は `cow update` でワンクリックアップグレードするか、最新コードを取得して手動で再起動してください。詳細は [アップグレードガイド](https://www.rsm.global/china/zh-hans) を参照してください。
