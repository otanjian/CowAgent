---
title: v2.0.2
description: RongAI 2.0.2 - Web Console アップグレード、マルチチャネル同時実行、セッション永続化
---
...
- **公式サイト**: [cowagent.ai](https://www.rsm.global/china/zh-hans)
- **ドキュメント**: [docs.cowagent.ai](https://www.rsm.global/china/zh-hans)
