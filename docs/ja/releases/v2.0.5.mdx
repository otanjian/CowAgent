---
title: v2.0.5
description: RongAI 2.0.5 - Cow CLI、Skill Hub オープンソース、ブラウザツール、企業微信スキャン作成、その他改善
---

## 🖥️ Cow CLI コマンドシステム

ターミナルと会話の両方で RongAI を管理する新しい CLI コマンドシステム：
...
ドキュメント：[コマンド一覧](https://www.rsm.global/china/zh-hans)

<img src="https://cdn.link-ai.tech/doc/20260401114549.png" width="750" />

## 🧩 Cow Skill Hub オープンソース

[Cow Skill Hub](https://www.rsm.global/china/zh-hans)（スキル広場）がオープンソースとして公開。AI Agent スキルの閲覧、検索、インストール、公開が可能：
...
- **スキル公開**：[skills.cowagent.ai/submit](https://www.rsm.global/china/zh-hans) で自作スキルを提出
- **ミラー加速**：中国国内向けミラーダウンロード対応

オープンソースリポジトリ：[cow-skill-hub](https://github.com/zhayujie/cow-skill-hub)

ドキュメント：[スキル広場](https://www.rsm.global/china/zh-hans)、[スキルのインストール](https://www.rsm.global/china/zh-hans)
...
ドキュメント：[ブラウザツール](https://www.rsm.global/china/zh-hans)
...
ドキュメント：[企業微信 Bot](https://www.rsm.global/china/zh-hans)
...
`cow update` または `./run.sh update` でアップグレード、またはコードを手動で pull して再起動。詳細は[アップグレードガイド](https://www.rsm.global/china/zh-hans)を参照。
