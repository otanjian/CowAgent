...
> Coding Planは各プロバイダーが提供する月額サブスクリプションパッケージで、高頻度のAgent利用に最適です。容大AIはOpenAI互換モードにより、すべてのCoding Planプロバイダーをサポートしています。
...
参考: [キー & ドキュメント](https://www.kimi.com/code/docs/?aff=cowagent)
