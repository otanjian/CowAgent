...
<Note>
  Agent モードでは、効果とコストのバランスを考慮して以下のモデルの利用を推奨します：deepseek-v4-flash、MiniMax-M3、claude-opus-5、claude-sonnet-5、gemini-3.7-flash、glm-5.3-flash、qwen3.8-flash、kimi-k3、ernie-5.1。
