...
[Cow Skill Hub](https://www.rsm.global/china/zh-hans) は、公式推奨・コミュニティ貢献・サードパーティ（GitHub、ClawHub など）のスキルを集約した、オープンソースの AI Agent スキルマーケットプレイスです。
...
- **ワンクリックインストール** — インストールコマンドをコピーして 容大AI で実行
...
1. [skills.cowagent.ai/submit](https://www.rsm.global/china/zh-hans) にアクセス
