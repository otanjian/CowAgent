---
title: Introduction
description: 容大AI - Open-source super AI assistant and Agent Harness
---

<div align="center">
  <img className="block dark:hidden" src="/images/rongda-ai-logo.svg" alt="容大AI" width="400px"/>
  <img className="hidden dark:block" src="/images/rongda-ai-logo-dark.svg" alt="容大AI" width="400px"/>
</div>

**容大AI** is an open-source super AI assistant and Agent Harness. It proactively plans tasks, runs tools and skills, and autonomously grows with memory and knowledge.

容大AI is lightweight, easy to deploy, and built to extend. Plug in any major LLM provider, quickly assemble a multi-agent team, run it across Web and major IM platforms, 24/7 on a personal computer or server.
...
<CardGroup cols={2}>
  ...
  <Card title="Try the Upstream Service Online" icon="cloud" href="https://link-ai.tech/cowagent/create">
    Try the upstream project hosted service without installation
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Multi-Agent Teams" icon="users" href="/multi-agent/team">
    Create multiple Agents with distinct roles to form a team, with group-chat collaboration, task delegation, and sub-Agents — usable in the Web console, desktop client, and channel integrations.
  </Card>
</CardGroup>

## Quick Start

The commands below install, configure, and start the upstream project. To use 容大AI with this repository’s changes, run this repository’s source or local build:
...
<Card title="Join our Discord" icon="discord" href="https://discord.gg/9U8eA8v9TR">
