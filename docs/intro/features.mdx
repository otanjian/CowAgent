---
title: Features
description: 容大AI long-term memory, task planning, skills system, CLI commands, and browser tool in detail
---
...
- [Skill Hub](https://www.rsm.global/china/zh-hans): An open skill marketplace featuring official, community, and third-party skills. Install with one command.
...
Visit [skills.cowagent.ai](https://www.rsm.global/china/zh-hans) to browse all available skills, or use commands in conversation:
...
容大AI provides two command interaction methods, covering service management, skill installation, configuration, and more:
...
See [Command Overview](https://www.rsm.global/china/zh-hans) for details.

## 6. Multi-Agent Teams

容大AI is no longer just a single Agent. You can create multiple Agents to form a team, each with its own responsibilities, model, skills, and knowledge, with isolated workspaces and memory. They can work independently or be brought into the same session to collaborate. A channel can bind a single Agent or the whole team to serve externally, making it easy to set up a team of digital employees.

<Frame>
  <img src="https://cdn.jsdelivr.net/gh/zhayujie/cowagent-assets@main/screenshots/en/team-overview.png" width="800" />
</Frame>

In a group-chat session, multiple Agents can participate together: use `@` to direct a member to answer, or let the lead Agent automatically **delegate** a task to a more suitable member and consolidate the reply. The lead Agent can also spin up temporary **sub-Agents** to handle independent subtasks in parallel, returning only the conclusion without cluttering the main conversation's context.

<Frame>
  <img src="https://cdn.jsdelivr.net/gh/zhayujie/cowagent-assets@main/screenshots/en/agent-group-session.png" width="800" />
</Frame>

See [Agent Teams](/multi-agent/team), [Task Delegation](/tools/delegate), and [Sub-Agents](/multi-agent/subagent) for details.
