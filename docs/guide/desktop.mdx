...
<Frame caption="It drives your browser, terminal, and file system directly, with long-term memory, a personal knowledge base, and self-evolution — all running locally.">
  <video controls preload="metadata" playsInline className="w-full rounded-xl" src="https://cdn.cowagent.ai/desktop/video/cow-demo-en-v1.mp4" />
</Frame>

## Download & Install

<Card title="Download the upstream client" icon="download" href="https://cowagent.ai/download/">
  Download the macOS / Windows installer
</Card>

<Tabs>
  <Tab title="macOS">
    1. Open the [upstream project download page](https://cowagent.ai/download/) and pick the build for your chip:
  ...
  <Tab title="Windows">
    1. Open the [upstream project download page](https://cowagent.ai/download/) and download the Windows installer (`.exe`).
