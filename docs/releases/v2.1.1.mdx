---
title: v2.1.1
description: RongAI 2.1.1 - Self-Evolution, Web Console message management and parallel sessions, cross-platform MCP enhancements, new models and improvements
---
...
RongAI introduces **Self-Evolution**, letting the agent go beyond completing a single task and keep improving through everyday collaboration with you:
...
Documentation: [Self-Evolution](https://www.rsm.global/china/zh-hans)
