---
title: v2.1.3
description: "RongAI 2.1.3: Desktop client for macOS / Windows, enhanced knowledge base document management, on-demand MCP tool retrieval, Traditional Chinese support, new models, plus security and experience improvements"
---

🌐 [English](https://www.rsm.global/china/zh-hans) | [中文](https://www.rsm.global/china/zh-hans)

## 🖥 Desktop Client

Introducing the **RongAI Desktop client** for **macOS and Windows** — your local super AI assistant, truly ready to use out of the box.

Download: [RongAI Desktop](https://www.rsm.global/china/zh-hans)

<img src="https://cdn.jsdelivr.net/gh/zhayujie/cowagent-assets@main/screenshots/en/desktop-chat-demo-en.png" alt="RongAI Desktop client" />
...
Docs: [Desktop Client](https://www.rsm.global/china/zh-hans)
...
Docs: [Knowledge Base](https://www.rsm.global/china/zh-hans)
...
Docs: [MCP Tools](https://www.rsm.global/china/zh-hans)
...
Docs: [Models](https://www.rsm.global/china/zh-hans)
...
- **Desktop client**: get the latest version from the [download page](https://www.rsm.global/china/zh-hans).
- **Source deployment**: run `cow update` for a one-click upgrade, or pull the latest code and restart. See the [upgrade guide](https://www.rsm.global/china/zh-hans).
