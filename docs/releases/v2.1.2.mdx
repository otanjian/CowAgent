---
title: v2.1.2
description: RongAI 2.1.2 - Web Console management upgrades, Self-Evolution improvements, new models, WeCom smart-bot callback mode, and security hardening
---
...
Documentation: [WeCom Smart Bot](https://www.rsm.global/china/zh-hans)
