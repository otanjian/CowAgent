---
title: v2.0.2
description: RongAI 2.0.2 - Web Console upgrade, multi-channel concurrency, session persistence
---
...
- **Official Website**: [cowagent.ai](https://www.rsm.global/china/zh-hans)
- **Documentation**: [docs.cowagent.ai](https://www.rsm.global/china/zh-hans)
