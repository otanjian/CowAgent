---
title: v2.0.7
description: RongAI 2.0.7 - Image Generation Skill (6-provider auto-routing), new models, knowledge base enhancements, Web Console improvements and bug fixes
---
...
Docs: [Image Generation Skill](https://www.rsm.global/china/zh-hans)
