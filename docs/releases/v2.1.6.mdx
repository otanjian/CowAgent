---
title: v2.1.6
description: "RongAI 2.1.6: sub agents for parallel task delegation, native reasoning-effort settings, a pluggable memory vector backend, and desktop client improvements"
---
...
Docs: [Sub Agents](https://www.rsm.global/china/zh-hans)
...
Docs: [Memory](https://www.rsm.global/china/zh-hans)
