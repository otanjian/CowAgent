---
title: v2.0.4
description: RongAI 2.0.4 - Personal WeChat channel, new model support, Japanese docs, script refactoring and bug fixes
---

## 🔌 Personal WeChat Channel

Added personal WeChat (`weixin`) channel — the most important update in this release. Simply scan a QR code to connect RongAI to your personal WeChat account, with support for:
...
Documentation: [WeChat Channel](https://www.rsm.global/china/zh-hans).
...
Run `./run.sh update` for a one-click upgrade, or manually pull the latest code and restart. See [Upgrade Guide](https://www.rsm.global/china/zh-hans) for details.
