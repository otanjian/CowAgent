---
title: v2.0.3
description: RongAI 2.0.3 - WeCom Smart Bot and QQ channels, Web Console file handling, memory system upgrade
---
...
Documentation: [QQ Bot](https://www.rsm.global/china/zh-hans).
...
See [Coding Plan docs](https://www.rsm.global/china/zh-hans) for detailed configuration.
