---
title: Changelog
description: RongAI version history
---

| Version | Date | Description |
| --- | --- | --- |
| [2.1.9](/releases/v2.1.9) | 2026.09.14 | Multi-Agent collaboration refinements, configurable model lists and multiple fallback models, channel integration fixes, and a range of image-generation and voice fixes |
| [2.1.8](/releases/v2.1.8) | 2026.09.10 | Multi-Agent teams (team management, group collaboration, multiple channel instances), manual scheduled tasks, context-usage visualization, model fallback and new search providers, workspace file editing |
