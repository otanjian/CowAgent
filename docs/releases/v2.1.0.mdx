---
title: v2.1.0
description: RongAI 2.1.0 - Internationalization, new Telegram / Discord / Slack / WeChat Customer Service channels, CLI interaction upgrades, MCP protocol enhancements and new models
---
...
- **Slack Bot**: Connect a Slack bot and bring RongAI into your team's workflow
...
Documentation: [Channels Overview](https://www.rsm.global/china/zh-hans)

## 🌍 Internationalization

RongAI introduces an end-to-end internationalization framework built for developers worldwide, adapting automatically based on the system language:
...
Documentation: [CLI Guide](https://www.rsm.global/china/zh-hans)
...
Documentation: [MCP Tools](https://www.rsm.global/china/zh-hans)
...
Documentation: [Models Overview](https://www.rsm.global/china/zh-hans)
...
Source-code deployments can run `cow update` for a one-click upgrade, or pull the latest code and restart manually. See the [Upgrade Guide](https://www.rsm.global/china/zh-hans) for details.
