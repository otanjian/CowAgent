---
title: v2.0.0
description: RongAI 2.0 - Full upgrade from chatbot to AI super assistant
---

RongAI 2.0 is a comprehensive upgrade from a chatbot to an **AI super assistant** — capable of autonomous thinking and task planning, long-term memory, operating computers, and creating and executing skills.
