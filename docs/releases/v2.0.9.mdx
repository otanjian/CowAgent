---
title: v2.0.9
description: RongAI 2.0.9 - Web Console model management, MCP protocol support, browser persistent login, new models and deployment hardening
---
...
Documentation: [MCP Tools](https://www.rsm.global/china/zh-hans). Thanks [@yangluxin613](https://github.com/yangluxin613) (#2801)
...
Documentation: [Browser Tool](https://www.rsm.global/china/zh-hans). Thanks [@leafmove](https://github.com/leafmove) (#2809)
...
- **TTS rolls out to more channels**: Web Console, Personal WeChat, Feishu, DingTalk and WeCom Smart Bot all support voice replies — see the [Channels Overview](https://www.rsm.global/china/zh-hans)
