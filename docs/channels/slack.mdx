---
title: Slack
description: Integrate 容大AI with a Slack App
---

> Integrate 容大AI into Slack via a Slack App in **Socket Mode**. Supports direct messages (DM) and channels (triggered by @mention or replying within a thread). Socket Mode uses a persistent WebSocket connection — no public IP or callback URL required, works out of the box.
...
2. Enter an **App Name** (e.g. `容大AI`), pick the **Workspace** to install into, and create it.
