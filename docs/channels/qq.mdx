---
title: QQ Bot
description: Connect 容大AI to QQ Bot (WebSocket long connection)
---

> Connect 容大AI via QQ Open Platform's bot API, supporting QQ direct messages, group chats (@bot), guild channel messages, and guild DMs. No public IP required — uses WebSocket long connection.
