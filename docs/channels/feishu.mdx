---
title: Feishu (Lark)
description: Integrate 容大AI into Feishu via a custom enterprise app
---

> Integrate 容大AI into Feishu via a custom enterprise app. Supports p2p chat and group chat (@bot), uses WebSocket long connection (no public IP needed), supports streaming typewriter replies and voice messages.
