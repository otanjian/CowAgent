---
title: WeCom
description: Integrate 容大AI into WeCom enterprise app
---

Integrate 容大AI into WeCom through a custom enterprise app, supporting one-on-one chat for internal employees.
