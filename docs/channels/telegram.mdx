---
title: Telegram
description: Integrate 容大AI with Telegram via the Bot API
---

> Integrate 容大AI into Telegram via the official Bot API. Supports private chat and group chat (triggered by @mention or replying to the bot). Uses Long Polling — no public IP required, works out of the box.
...
2. Send `/newbot` and follow the prompts:
   - **Bot name** (display name, e.g. `My 容大AI Bot`)
