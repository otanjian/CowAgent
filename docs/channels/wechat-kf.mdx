...
description: Integrate 容大AI into WeChat Customer Service
---

By binding a WeCom custom enterprise app to a WeChat Customer Service account, 容大AI can take over inbound inquiries from external WeChat users and serve them through links or QR codes embedded in WeChat Mini Programs, Official Accounts, Video Channels, and Video Channel stores.
