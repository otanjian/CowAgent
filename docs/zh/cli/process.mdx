---
title: 进程管理
description: 使用 cow 命令管理 容大AI 进程的启动、停止、重启、更新等操作
---

进程管理命令用于控制 容大AI 后台进程的生命周期。这些命令仅在终端中可用。

## start

启动 容大AI 服务。默认以后台进程方式运行，并自动跟踪日志输出。
...
查看 容大AI 服务运行状态，包括进程信息、版本号、当前配置的模型和通道。
