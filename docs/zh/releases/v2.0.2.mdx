---
title: v2.0.2
description: RongAI 2.0.2 - Web 控制台升级、多通道同时运行、会话持久化
---
...
- **官网上线**：[cowagent.ai](https://www.rsm.global/china/zh-hans)
- **文档中心上线**：[docs.cowagent.ai](https://www.rsm.global/china/zh-hans)
