---
title: v2.0.7
description: RongAI 2.0.7 - 图像生成技能（六厂商自动路由）、新模型支持、知识库增强、Web 控制台优化及多项修复
---
...
相关文档：[图像生成技能](https://www.rsm.global/china/zh-hans)
...
- **自定义模型厂商**：新增[自定义模型](https://www.rsm.global/china/zh-hans)提供方配置，方便接入本地模型及更多厂商
