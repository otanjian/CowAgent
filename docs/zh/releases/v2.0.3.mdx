---
title: v2.0.3
description: RongAI 2.0.3 - 新增企微智能机器人和 QQ 通道、Web 控制台文件处理、记忆系统升级
---
...
接入文档：[企微智能机器人接入](https://www.rsm.global/china/zh-hans)。
...
接入文档参考：[QQ机器人接入](https://www.rsm.global/china/zh-hans)。
...
详细配置参考 [Coding Plan 文档](https://www.rsm.global/china/zh-hans)。
...
源码部署可执行 `./run.sh update` 一键升级，或手动拉取代码后重启。详见 [更新升级文档](https://www.rsm.global/china/zh-hans)。
