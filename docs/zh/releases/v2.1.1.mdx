---
title: v2.1.1
description: RongAI 2.1.1：自主进化能力、Web 控制台消息管理与多会话并行、MCP 跨平台增强、多模型接入与优化
---
...
RongAI 新增 **自主进化（Self-Evolution）** 能力，让 Agent 不止于完成单次任务，而是在与你的日常协作中持续成长：
...
相关文档：[自主进化](https://www.rsm.global/china/zh-hans)
