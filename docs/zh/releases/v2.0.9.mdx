---
title: v2.0.9
description: RongAI 2.0.9 - 新增模型管理、MCP 协议支持、浏览器登录态持久化、新模型接入
---
...
相关文档：[MCP 工具](https://www.rsm.global/china/zh-hans)。Thanks @yangluxin613 (#2801)
...
相关文档：[浏览器工具](https://www.rsm.global/china/zh-hans)。Thanks @leafmove (#2809)
...
- **TTS 适配更多通道**：Web对话、个人微信、飞书、钉钉、企微智能机器人均已支持回复语音，详情查看 [通道概览](https://www.rsm.global/china/zh-hans)
