---
title: v2.0.6
description: RongAI 2.0.6 - 知识库系统、梦境记忆蒸馏、上下文智能压缩、Web 控制台多会话及多项优化
---

## 项目正式更名为 RongAI

项目仓库正式从 `chatgpt-on-wechat` 更名为 **RongAI**，演进为功能完备的 AI Agent 助理。
...
相关文档：[梦境蒸馏](https://www.rsm.global/china/zh-hans)
...
相关文档：[短期记忆](https://www.rsm.global/china/zh-hans)
...
- **视觉识别优化**：图片识别工具优先使用主模型，支持多模型厂商自动降级。相关文档：[视觉工具](https://www.rsm.global/china/zh-hans)
