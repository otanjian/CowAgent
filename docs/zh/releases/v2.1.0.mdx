---
title: v2.1.0
description: RongAI 2.1.0 - 国际化支持、新增 Telegram / Discord / Slack / 微信客服通道、命令行交互升级、MCP协议增强、新模型接入
---
...
相关文档：[通道概览](https://www.rsm.global/china/zh-hans)

## 🌍 国际化支持

RongAI 引入全链路国际化框架，面向全球开发者，支持根据系统语言自动适配：
...
相关文档：[命令行指南](https://www.rsm.global/china/zh-hans)
...
源码部署可执行 `cow update` 一键升级，或手动拉取代码后重启。详见 [更新升级文档](https://www.rsm.global/china/zh-hans)。
