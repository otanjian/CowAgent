---
title: v2.0.5
description: RongAI 2.0.5 - Cow CLI、Skill Hub 开源、浏览器工具、企微扫码创建、DeepSeek 独立模块及多项优化
---

## 🖥️ Cow CLI 命令系统

新增 Cow CLI 命令系统，支持在终端和对话中执行命令，实现对 RongAI 的全方位管理：
...
相关文档：[命令总览](https://www.rsm.global/china/zh-hans)

<img src="https://cdn.link-ai.tech/doc/20260401114549.png" width="750" />

## 🧩 Cow Skill Hub 开源

[Cow Skill Hub](https://www.rsm.global/china/zh-hans)（技能广场）正式开源并上线，提供 AI Agent 技能的浏览、搜索、安装和发布，汇集精选技能、社区贡献技能、三方技能：
...
- **技能发布**：通过 [skills.cowagent.ai/submit](https://www.rsm.global/china/zh-hans) 提交自己的技能
- **镜像加速**：支持 Skill Hub 镜像加速，国内环境下载更流畅

Skill Hub 开源仓库：[cow-skill-hub](https://github.com/zhayujie/cow-skill-hub)。

相关文档：[技能广场](https://www.rsm.global/china/zh-hans)、[安装技能](https://www.rsm.global/china/zh-hans)
...
相关文档：[浏览器工具](https://www.rsm.global/china/zh-hans)。
...
相关文档：[企微智能机器人接入](https://www.rsm.global/china/zh-hans)。
...
源码部署可执行 `cow update` 或 `./run.sh update` 一键升级，或手动拉取代码后重启。详见 [更新升级文档](https://www.rsm.global/china/zh-hans)。
