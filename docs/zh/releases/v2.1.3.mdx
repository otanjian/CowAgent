---
title: v2.1.3
description: RongAI 2.1.3：正式推出桌面客户端（macOS / Windows），知识库文档管理增强，新增 MCP 工具按需检索，繁体中文支持，模型支持，并带来安全与体验的多项改进
---
...
正式推出 **RongAI 桌面客户端**，支持 **macOS 与 Windows**，让本地超级 AI 助理真正做到开箱即用。

下载地址：[RongAI客户端](https://www.rsm.global/china/zh-hans)

<img src="https://cdn.jsdelivr.net/gh/zhayujie/cowagent-assets@main/screenshots/zh/desktop-chat-demo-zh.png" alt="RongAI 桌面客户端" />
...
相关文档：[桌面客户端](https://www.rsm.global/china/zh-hans)
...
相关文档：[模型概览](https://www.rsm.global/china/zh-hans)
...
- **桌面客户端**：前往 [下载页](https://www.rsm.global/china/zh-hans) 获取最新版本。
- **源码部署**：执行 `cow update` 一键升级，或手动拉取代码后重启。详见 [更新升级文档](https://www.rsm.global/china/zh-hans)。
