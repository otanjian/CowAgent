---
title: 功能介绍
description: 容大AI 长期记忆、个人知识库、任务规划、技能系统、CLI 命令、浏览器工具详细说明
---
...
- [Skill Hub](https://www.rsm.global/china/zh-hans)：开放的技能广场，汇集官方推荐、社区贡献和第三方技能，支持一键安装。
...
访问 [skills.cowagent.ai](https://www.rsm.global/china/zh-hans) 浏览所有可用技能，或在对话中执行：
...
容大AI 提供两种命令交互方式，覆盖服务管理、技能安装、配置调整等日常运维操作：
...
详细命令参考 [命令总览](https://www.rsm.global/china/zh-hans)。

<img src="https://cdn.link-ai.tech/doc/20260401114549.png" width="750" />

## 6. 多智能体团队

容大AI 不止是一个 Agent，你可以创建多个 Agent 组成团队，每个成员有自己的职责、模型、技能与知识，工作空间和记忆互相隔离，既能独立工作，也能被拉进同一会话协作。通道可绑定单个 Agent 或整个团队对外服务，轻松搭建一支数字员工团队。

<Frame>
  <img src="https://cdn.link-ai.tech/doc/e0750df7b766ee63dfb341e30e181859.png" width="800" />
</Frame>

在群聊会话中，多个 Agent 可以共同参与：通过 `@` 指定成员回答，或由主 Agent 自动**委派**任务给更合适的成员处理，再统一汇总回复。此外，主 Agent 还可临时创建**子 Agent** 并行处理独立子任务，只返回结论、不占用主对话上下文。

<Frame>
  <img src="https://cdn.link-ai.tech/doc/20260908194946.png" width="800" />
</Frame>

详细说明请参考 [Agent 团队](/zh/multi-agent/team)、[任务委派](/zh/tools/delegate) 和 [子 Agent](/zh/multi-agent/subagent)。
