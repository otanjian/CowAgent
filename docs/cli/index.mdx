...
description: 容大AI command system — Terminal CLI and chat commands
---

容大AI provides two ways to interact via commands:
...
Service:
  start     Start the 容大AI service
  stop      Stop the 容大AI service
  restart   Restart the 容大AI service
