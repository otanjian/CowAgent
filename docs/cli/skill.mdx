...
Skill management commands are used to install, query, and manage 容大AI skills. Use `/skill <subcommand>` in chat or `cow skill <subcommand>` in the terminal.
...
| `cowhub` | Installed from RongAI Skill Hub |
